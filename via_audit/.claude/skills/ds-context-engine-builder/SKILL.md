---
name: ds-context-engine-builder
...
references:
  ...
  - ../_knowledge-notes/component-bestiary-reference.md
  - ../_knowledge-notes/agent-orchestration-guide.md
  - ../_knowledge-notes/mcp-setup-guide.md
  - ../_knowledge-notes/context-engine-blueprints.md
---
...
Before producing output, check for a `sdd.config.md` (seção 12) file in the project root. If present, load:
...
If integrations are configured in `sdd.config.md` (seção 12), pull data automatically:
