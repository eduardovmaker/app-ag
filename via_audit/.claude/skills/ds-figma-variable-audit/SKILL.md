...
If `sdd.config.md` (seção 12) specifies `integrations.figma.file_key`, use it automatically without asking.
...
If `sdd.config.md` (seção 12) specifies `integrations.code_tokens`, pull the code token source and compare:
