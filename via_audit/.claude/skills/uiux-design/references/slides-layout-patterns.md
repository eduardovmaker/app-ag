...
python .claude/skills/uiux-design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python .claude/skills/uiux-design-system/scripts/search-slides.py "traction slide" \
