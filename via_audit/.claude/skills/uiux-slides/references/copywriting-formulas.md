...
python .claude/skills/uiux-design-system/scripts/search-slides.py "problem agitation" -d copy

# Get emotion-appropriate formula
python .claude/skills/uiux-design-system/scripts/search-slides.py "urgency cta" -d copy
```
